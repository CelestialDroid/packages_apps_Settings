...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, CELESTIALGEARNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, CELESTIALGEARNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(CELESTIALGEARNS, "interval");
            if(newInterval != null)
