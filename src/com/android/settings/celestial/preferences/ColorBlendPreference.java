...
import com.android.settings.celestial.preferences.colorpicker.ColorPickerDialog;
...
public class ColorBlendPreference extends Preference
    ...
    private static final String CELESTIALGEARNS = "http://schemas.android.com/apk/res-auto";
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            mPreviewLed = attrs.getAttributeBooleanValue(CELESTIALGEARNS, "ledPreview", false);
    ...
    private void updateDialogSliderPreview() {
        ...
        int previewColor = CelestialUtils.getBlendColorForPercent(mPreviewColorEnd, mPreviewColorStart,
    ...
    private void updatePreview() {
        ...
        if (mViewColorBetween != null) {
            mViewColorBetween.setBackgroundColor(
                    CelestialUtils.getBlendColorForPercent(mColorEnd, mColorStart, mBlendReverse, 50));
        }
    }
