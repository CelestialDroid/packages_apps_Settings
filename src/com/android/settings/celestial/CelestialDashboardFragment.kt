...
package com.android.settings.celestial.fragments
...
abstract class CelestialDashboardFragment: DashboardFragment() {
    override fun getMetricsCategory(): Int = MetricsProto.MetricsEvent.CELESTIAL_SETTINGS
...
/*    override fun onDisplayPreferenceDialog(preference: Preference) {
    ...
    companion object {
        const val REQUEST_KEY = "CelestialDashboardFragment#RequestKey"
